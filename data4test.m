...
M = 5; %each set has 9 pics of the same view,
dep1 = cell(N,M); % 
img = cell(1,N);
avgd = cell(1,N);
pos = [];
...
%     depp =  sprintf('C:\\MANUS\\test\\capture_img10\\depimg%d.png',n);  % load all the depth img
    depp =  sprintf('C:\\MANUS\\CommonSpace\\new_vision\\0725\\%d\\capture_img\\depimg%d.png',n0,n);  % load all the depth img  new_vision\\
